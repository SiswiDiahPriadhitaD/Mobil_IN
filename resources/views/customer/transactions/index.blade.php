  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p class="text-center text-danger">Silahkan lakukan pembayaran, datang ke deller Mobil-IN dan lakukan pembayaran! setelah membayar status akan menjadi [paid-detail]</p>
      </div>
